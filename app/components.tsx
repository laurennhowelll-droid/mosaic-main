...
export function Logo() { return <Image className="logo" src="/brand-reference/main-logo.svg" alt="Mosaic — Businesses That Work Beautifully" width={240} height={86} priority />; }
