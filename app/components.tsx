...
export function Header() {
  return <header className="site-header"><Link className="brand" href="/"><Logo /></Link><nav aria-label="Primary"><Link href="/services">How We Help</Link><Link href="/process">Our Process</Link><Link href="/work">Work</Link><Link href="/about">About</Link><Link href="/playbook">Playbook</Link></nav><Link className="header-cta" href="/start">Start With Vision <b>↗</b></Link></header>;
}
